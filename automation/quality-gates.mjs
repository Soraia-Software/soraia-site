...
const LENSES = [
  { g: "fact-check", crit: `Every number/%, price, date, and client claim must be traceable to public/llms.txt or a published case study. FAIL if any is unverifiable, fabricated, or if it cites/links 40factory or oggi-lavoro (both draft → 404), or links a non-existent route.\n\nSOURCE OF TRUTH (llms.txt):\n${llms.slice(0, 6000)}` },
