...
const labels = {
  it: {
    title: "Parliamo del tuo recruitment",
    subtitle:
      "Lasciaci due righe sulla tua agenzia. Ti ricontattiamo entro 24 ore con una proposta di assessment.",
    name: "Nome e cognome",
    company: "Agenzia",
    role: "Ruolo",
    email: "Email aziendale",
    recruiters: "Recruiter nel team",
    message: "Cosa ti farebbe recuperare più ore?",
    ...
    range_1: "1–5 recruiter",
    range_2: "6–15 recruiter",
    range_3: "16–40 recruiter",
    range_4: "40+ recruiter",
  },
  en: {
    title: "Let's talk about your recruitment",
    subtitle:
      "A couple of lines about your agency. We'll reply within 24 hours with an assessment proposal.",
    name: "Full name",
    company: "Agency",
    role: "Role",
    email: "Work email",
    recruiters: "Recruiters in team",
    message: "What would give your team back the most hours?",
    ...
    range_1: "1–5 recruiters",
    range_2: "6–15 recruiters",
    range_3: "16–40 recruiters",
    range_4: "40+ recruiters",
  },
} as const;
