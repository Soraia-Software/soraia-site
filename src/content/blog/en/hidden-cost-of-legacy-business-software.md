---
title: "Replacing legacy business software: the hidden cost"
description: "Legacy ERP in industrial SMEs costs more than you think: slow onboarding, key-person risk, vendor lock-in. When to modernise and when to replace."
pubDate: 2026-06-24
author: "Daniel Levis"
tags:
  - "custom software"
  ...
  - "strategy"
keywords:
  - "replace legacy business software"
  - "legacy software cost"
  - "SME ERP"
  - "vendor lock-in"
readMinutes: 6
featured: false
h1: "The hidden cost of the business software nobody wants to use anymore"
faq:
  - q: "When is it worth replacing legacy business software?"
    a: "When the hidden cost (slow onboarding, key-person risk, lock-in) outweighs the cost of replacement. The strongest signal is <strong>key-person risk</strong>: if only one person knows how to use it and they leave, you're stuck. Before deciding, measure what it really costs you today, not the price the vendor quotes you."
