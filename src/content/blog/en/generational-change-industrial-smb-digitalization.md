...
tags:
  ...
  - "change-management"
keywords:
  - "generational change company digitalization"
  - "digitalizing manufacturing SMBs"
  - "family business succession"
readMinutes: 6
featured: false
h1: "Generational change: what to digitalize when the next generation takes over"
faq:
  - q: "Where do you start digitalizing when the next generation joins?"
    a: "From the process that costs you the most hours and gives you the least visibility, not the newest or coolest one. It's almost always where Excel, paper and people's heads coexist. Measure what that process costs today, then decide. <a href='/en/ai-adoption'>Without a baseline</a> you're choosing on gut feel."
  - q: "Do I have to throw out the ERP my father has used for twenty years?"
    a: "No, almost never. TeamSystem, Zucchetti or Odoo stay the accounting core. The problem isn't the ERP, it's everything orbiting it outside the system: parallel Excel files, email, printed sheets. You digitalize that perimeter, not the core that already works."
  - q: "How do I avoid the clash between old and new guard?"
    a: "You don't start from the software, you start from the people who'll use it daily. The old guard knows the exceptions no manual documents: that knowledge must be extracted, not bypassed. An <a href='/en/ai-adoption'>AI Adoption</a> program is built exactly for this."
...
Then there's the commercial side, often the most neglected. At ILTEC, an office technology firm in Biella, we rebuilt the AI-search-optimized website in 3 weeks and placed a commercial agent reachable via QR code right on the equipment: the customer scans, asks a question, the agent answers. It's [the kind of intervention](/en/case-studies/iltec) the new generation grasps immediately and the old guard accepts because it touches nothing that already works.
...
If you're joining the company and don't know where to start, [let's talk](/en/contact): 20 minutes, no pitch. Or take the [check-up](/en/check-up) in 3 minutes to figure out which process is worth digitalizing first.
