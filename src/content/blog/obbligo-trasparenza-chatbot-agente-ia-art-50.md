...
faq:
  ...
  - q: "Il Digital Omnibus di giugno 2026 cambia le scadenze?"
    a: "Il pacchetto di semplificazione discusso a metà 2026 punta a ridurre gli oneri documentali per le PMI, ma gli obblighi di trasparenza dell'Art. 50 restano la baseline. Pianifica sulla data certa (2 agosto 2026) e adatta se e quando arrivano deroghe ufficiali, non prima."
...
- Il **Digital Omnibus di giugno 2026** punta a semplificare gli oneri documentali per le PMI, ma l'Art. 50 resta la baseline: pianifica sulla data certa.
...
La multa massima teorica è alta, ma per le PMI il rischio reale non è la sanzione: è arrivare al controllo (o al reclamo di un cliente) senza prove di cosa il bot ha mostrato e quando.
