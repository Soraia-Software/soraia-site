...
stats:
  - value: "Multi-stakeholder"
    label: "Workflow approvazioni"
    sub: "property owner + provider + agency"
  - value: "Hosted programs"
    label: "Template incentive"
    sub: "configurabili per cliente"
  - value: "Q1 2025"
    label: "Migration WeWeb completata"
    sub: "da legacy stack"
timeline: "Cliente storico Soraia 18+ mesi, sprint continui mensili"
stack:
  - "Xano (backend)"
  - "WeWeb (frontend)"
...
**Single source of truth su centinaia di parcel** gestiti nel sistema. Non più dati duplicati tra Bubble, Airtable e CRM.
