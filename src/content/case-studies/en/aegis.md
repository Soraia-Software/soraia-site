...
service: "Recruitment platform with integrated AI agents"
pubDate: 2026-04-05
dimensioni: "51-250"
featured: true
lang: "en"
...
stats:
  ...
  - value: "7"
    label: "Group lines"
    sub: "aligned on the same system"
  - value: "AI Agents"
    label: "CV parsing + dedup"
    sub: "running autonomously"
timeline: "V1 live February 2026, continuous development to embed more AI across processes"
stack:
  - "Xano (multi-tenant backend)"
  - "WeWeb (recruiter frontend)"
  - "OpenAI (CV parsing)"
  - "Anthropic (comparative eval)"
  - "Custom multi-brand permissions layer"
related:
  - "talent-match"
  - "stars-be-original"
  - "cxl"
...
Aegis Group ("Driving business through people") is an Italian Human Consulting group headquartered in Milan, structured across 7 vertical business lines:
...
Each line has its own team, its own open roles, and its own rules for working with candidates. Together, they manage a database of over **350,000 candidates**.
...
The result: senior recruiters and managers were burning high-value time on data entry and reconciliation instead of advising candidates and clients.
...
**350,000+ candidates on a single platform**, all searchable through the same interface, with consistent history, notes, and pipeline status across lines.

**7 lines aligned** on the same system, each with its own specific rules running on shared infrastructure.
...
The platform is live and we continue to iterate with regular sprints to **embed more AI into the group's specific workflows** and free up more recruiter time. Next areas: automatic candidate↔role matching, agent-assisted candidate outreach, and dynamic pipeline scoring.
