---
title: "ILTEC: website rebuilt in 3 weeks with AI search optimization + AI agent"
client: "ILTEC"
clientLogo: "/logos/clients/iltec.webp"
industry: "sales-marketing"
additionalIndustries: ["customer-support"]
sector: "B2B office technology · Biella region"
service: "AI-ready website rebuild + commercial AI agent via QR"
lang: "en"
pubDate: 2026-02-10
dimensioni: "1-10"
featured: false
...
stats:
  - value: "3 wks"
    label: "Site go-live"
    sub: "from scratch · high-converting + AI-ready"
  - value: "3x"
    label: "Conversion rate"
    sub: "lead form vs. previous site"
  - value: "QR + AI"
    label: "On every installed machine"
    sub: "technical/commercial support 24/7"
timeline: "Site live 2026-Q2 · AI agent QR rolling out across installed base"
stack:
  - "Astro 5 (SSG site)"
  - "Cloudflare Pages (hosting)"
  - "Schema.org + structured data (AI search)"
  - "Custom AI agent (Anthropic Claude)"
  - "Dynamic QR codes per machine"
related:
  - "storywonder"
  - "cxl"
  - "stars-be-original"
...
Two converging problems were slowing growth.
...
- No thematic FAQs for LLMs to consume.
- A long lead form with a sub-1% conversion rate.

For a B2B with strong local authority but weak AI indexing, **60% of B2B buyers using ChatGPT/Claude to shortlist vendors simply weren't finding ILTEC**.

### 2. Post-sale support was eating the team's time

Every client with an installed machine called ILTEC about:
- Consumables (cartridges, toner, maintenance kits).
- Configurations (drivers, network, scan-to-email).
...
### Intervention 1: high-converting + AI-ready website rebuild

In 3 weeks, Soraia rebuilt the site from scratch on Astro + Cloudflare Pages.

**On the lead generation side:**
- Multistep form with tracked micro-conversions.
- Structured data on products, services, and contact information.
- Social proof in key positions (client logos, years in business, installed base size).
- Lighthouse performance 95+ on mobile.

**On the AI search optimization (GEO) side:**
- Full schema.org markup (`Organization`, `Service`, `LocalBusiness`, `FAQPage`).
- Rigorous semantic HTML (`<article>`, `<section>`, `<aside>`, hierarchical h1–h6).
- Thematic FAQs written in question-and-answer format, optimized to be cited by LLMs.
- Service content built to be consumable: every service has a self-contained descriptive block that an LLM can extract as a citation.

### Intervention 2: QR code + AI agent on every installed machine

Every machine in the installed base (and all new deliveries) now has a **dedicated QR code** physically applied. When a client scans it:
...
- **Site live in 3 weeks** from scratch, high-converting + AI-ready.
- **Conversion rate tripled** on the lead form vs. the previous site.
- **Visibility on ChatGPT and Perplexity** for sector searches in the Biella area within months of launch.
- **AI agent live** across the installed machine base, autonomously routing routine requests.
- The sales team frees up time for new business; technical support focuses on complex cases.
