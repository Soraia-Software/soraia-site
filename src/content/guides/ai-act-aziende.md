---
title: "AI Act per Aziende: cosa cambia davvero in operatività"
h1: "AI Act per Aziende italiane: la guida operativa 2026"
description: "I 4 livelli di rischio dell'AI Act, cosa cambia per HR, finance, marketing, support, i 4 step concreti che ogni PMI italiana deve fare. Aggiornata maggio 2026."
pubDate: 2026-04-22
...
related:
  ...
  - "costi-consulenza-ai"
faq:
  - q: "L'AI Act riguarda anche le PMI italiane?"
    a: "Sì, ma in modo proporzionato. La maggior parte delle PMI ricade in <strong>livello limitato o minimo</strong> di rischio. Gli obblighi sostanziali sono limitati a 4 step concreti (audit log, policy, DPA, supervisione umana sui casi critici). Le multe fino al 7% del fatturato che girano nelle email scaremongering riguardano violazioni gravi su sistemi ad alto rischio, non l'uso ordinario di ChatGPT in ufficio."
  ...
  - q: "Recruitment con AI: che obblighi ho?"
    a: "Sistemi che <strong>decidono o influenzano significativamente</strong> assunzioni/promozioni/valutazioni ricadono in livello alto. Obblighi: <strong>risk assessment documentato</strong>, <strong>logging completo</strong> delle decisioni, <strong>supervisione umana</strong> sui casi limite, <strong>comunicazione ai candidati</strong> che AI è coinvolta, <strong>conservazione record per 6 anni</strong>. Soraia gestisce questo livello in ogni progetto recruitment."
  - q: "Cosa è una DPIA e quando serve?"
    a: "DPIA = Data Protection Impact Assessment. <strong>Obbligatoria</strong> per sistemi AI ad alto rischio che trattano dati personali in modo nuovo o su larga scala. Per la maggior parte delle PMI: serve per recruitment automation, customer scoring, processi che valutano persone. Documento di 5-15 pagine che mappa rischi + mitigazioni. Soraia la include come deliverable nei progetti su settori regolamentati."
  - q: "Quali sono le multe dell'AI Act?"
    a: "<strong>Fino a 35 milioni di € o 7% fatturato annuo</strong> (max tra i due) per violazioni gravi su sistemi proibiti. <strong>Fino a 15 milioni o 3% fatturato</strong> per non conformità su sistemi ad alto rischio. <strong>Fino a 7,5 milioni o 1% fatturato</strong> per informazioni false/scorrette alle autorità. Per le PMI il rischio reale è basso se rispettano i 4 step base."
  - q: "Devo nominare un AI Officer?"
    a: "<strong>NO</strong> per la maggior parte delle PMI. L'AI Act non obbliga la nomina di un AI Officer dedicato. Per organizzazioni che usano sistemi ad alto rischio è consigliabile assegnare la responsabilità a un manager esistente (DPO, Compliance, IT) senza creare nuove figure. Le agency esterne (es. Soraia) possono affiancare come consulenti sul tema."
---
...
| Alto | Recruitment, credito, sanità | Risk assessment, logging, supervisione umana, DPIA, record 6 anni |
| Limitato | Chatbot, AI-generated content | Trasparenza |
| Minimo | ChatGPT in ufficio, filtri spam | Residuali |
...
| Tipo violazione | Multa massima |
|---|---|
| Pratiche AI vietate | €35M o 7% fatturato (max tra i due) |
| Non conformità sistemi alto rischio | €15M o 3% fatturato |
| Informazioni false/scorrette | €7,5M o 1% fatturato |
...
Vuoi una valutazione del tuo caso specifico sotto l'AI Act? **[Fai il check-up in 3 minuti](/check-up)** per capire dove sei, oppure **[parla 20 minuti con Daniel](/parliamone)** per discutere insieme i tuoi sistemi AI attuali e gli obblighi reali.
