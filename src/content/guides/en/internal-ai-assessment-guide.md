---
title: "Internal AI Assessment: The Operative Guide"
h1: "Internal AI Assessment: What to Map Before You Call a Vendor"
description: "How to run an internal AI readiness assessment before hiring anyone: map processes, data, wasted hours and baseline. Operative guide for SME CEOs and COOs."
pubDate: 2026-07-15
author: "Daniel Levis"
readMinutes: 11
keywords:
...
faq:
  - q: "What is an internal AI assessment?"
    a: "It's a 1-2 week exercise where you map <strong>processes, data, wasted hours and constraints</strong> before talking to any vendor. It's not about picking the technology: it tells you where AI makes sense, where it doesn't, and gives you a <strong>measurable baseline</strong> to judge the quotes you'll receive."
  - q: "Should I do it myself or pay a consultant?"
    a: "The lightweight version you do internally in 1-2 weeks, at zero cost, with this guide. You only need management and department-head time. A <strong>paid assessment</strong> (typically €1,500-3,000, often refunded if you proceed) makes sense afterward, when you want a detailed operative plan with a baseline timed by whoever will build."
  - q: "How do I calculate wasted hours on a process?"
    a: "Take the process, count its monthly runs, time 3-5 real runs (not memory-based estimates), then multiply. Next, separate the <strong>repetitive, rule-based</strong> part (an AI candidate) from the part that needs human judgment. The first is your recoverable potential, the second isn't."
  - q: "What data do I need to know if a process is automatable?"
    a: "Three things: where the data lives (ERP, email, PDFs, scattered spreadsheets), in what format, and whether it's accessible via API or export. A process running on structured, accessible data is <strong>far cheaper</strong> to automate than one that depends on non-standard PDFs or knowledge stuck in people's heads."
  - q: "How do I know if my case is really ready for AI?"
...
1. **It gives you a concrete use case** instead of "we want to do AI". A serious vendor literally can't quote without this.
2. **It gives you a measurable baseline** (hours, costs, volumes), the number against which you'll judge any promised result.
3. **It exposes the processes that aren't ready** before you pay for them. A process running on data scattered across spreadsheets and knowledge in people's heads costs far more to automate, and sometimes isn't worth it.

This is the same work a good partner would do in their paid assessment. Doing it first, in a lightweight form, saves you time and makes you a much harder client to fool. On how to actually pick the partner afterward, the [guide on AI consulting](/en/guide/ai-consulting-italy) covers criteria and red flags.
...
Example: in CV screening, AI can read 100k+ candidates and filter on objective criteria (as in the [APraise](/en/case-studies/apraise) case, where the agent handles 100k+ candidates, equivalent to roughly 4 extra recruiters), but the final call on a borderline candidate stays with the recruiter. Estimating this percentage tells you how much of your wasted time is genuinely recoverable.
...
Don't start with more than one process. The [guide on AI consulting costs](/en/guide/ai-consulting-costs) explains why narrow scope is almost always the right call for a first agent.

## The final document: 1 page

At the end of the internal assessment you should have **one page** containing:

1. The chosen priority process (one).
2. The timed baseline (hours/month, runs, average time).
3. Where the data lives and in what format.
4. The estimated % of rule-based work vs human judgment.
5. The target you'd want to reach (e.g. "recover 40 of the 60 hours/month").
...
If you want an honest read on your case, with no pitch and no surprise quote, [talk to us for 20 minutes](/en/contact). If, after seeing your numbers, we think the right answer is "not yet" or "an off-the-shelf tool is enough", we'll say so. We'd rather tell you the truth than sell you a sprint you don't need.
